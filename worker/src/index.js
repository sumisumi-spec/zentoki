...
function cors(env, res) { res.headers.set('Access-Control-Allow-Origin', env.ALLOWED_ORIGIN || '*'); res.headers.set('Access-Control-Allow-Headers', 'Content-Type'); res.headers.set('Access-Control-Allow-Methods', 'POST, OPTIONS'); return res; }
